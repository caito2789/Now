...
Public Class InpeDA
    ...
    Public Function RegistrarLog(ByVal objFiltro As InpeBE) As Integer
        ...
        Try
            ...
            Using conexion = New OracleConnection(ConfiguracionBase.K_CADENA_CONEXION)
                ...
                cmd.Parameters.Add(New OracleParameter("PV_NOMBRES1", OracleDbType.Varchar2, 500)).Value = objFiltro.Nombres1
                cmd.Parameters.Add(New OracleParameter("PV_NOMBRES2", OracleDbType.Varchar2, 500)).Value = objFiltro.Nombres2
                cmd.Parameters.Add(New OracleParameter("PV_NOMBRES3", OracleDbType.Varchar2, 500)).Value = objFiltro.Nombres3
