    ...
    Public Function RegistrarLog(ByVal objFiltro As MigracionesBE) As Integer
        ...
        Try
            ...
            Using conexion = New OracleConnection(ConfiguracionBase.K_CADENA_CONEXION)
                ...
                cmd.Parameters.Add(New OracleParameter("PV_CE", OracleDbType.Varchar2, 11)).Value = objFiltro.CE
                cmd.Parameters.Add(New OracleParameter("PV_APE_PRI", OracleDbType.Varchar2, 500)).Value = objFiltro.ApePrimer
                cmd.Parameters.Add(New OracleParameter("PV_APE_SEG", OracleDbType.Varchar2, 500)).Value = objFiltro.ApeSegundo
                cmd.Parameters.Add(New OracleParameter("PV_NOMBRES", OracleDbType.Varchar2, 500)).Value = objFiltro.Nombres
                cmd.Parameters.Add(New OracleParameter("PV_CALIDAD_MIGR", OracleDbType.Varchar2, 500)).Value = objFiltro.CalidadMigratoria
