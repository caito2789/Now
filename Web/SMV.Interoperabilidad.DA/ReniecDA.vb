...
Public Class ReniecDA

    Public Function RegistrarLog(ByVal objFiltro As ReniecBE) As Integer
        ...
        Try
            ...
            Using conexion = New OracleConnection(ConfiguracionBase.K_CADENA_CONEXION)
                ...
                cmd.Parameters.Add(New OracleParameter("PV_FEC_NAC", OracleDbType.Varchar2, 10)).Value = objFiltro.FechaNacimiento
                cmd.Parameters.Add(New OracleParameter("PV_SEXO", OracleDbType.Varchar2, 1)).Value = objFiltro.Sexo
