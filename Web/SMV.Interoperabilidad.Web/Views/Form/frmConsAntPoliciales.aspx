<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Views/Shared/mpPrincipal.Master" CodeBehind="frmConsAntPoliciales.aspx.vb" Inherits="SMV.Interoperabilidad.Web.frmConsAntPoliciales" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    function js_ValidarFiltros() {
        var blntxtApePaterno = false; var blntxtApeMaterno = false; var blntxtNombres = false; var blntxtDNI = false;
        var strMjError = "";
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <header class="panel-heading" style="padding-bottom:1px;">        
        <div class="dvTitFormA">Ministerio del Interior (MININTER): Consulta de Antecedentes Policiales</div>
    </header>   
    <div class="panel-body">
        <div class="dvTitFormB">
            <label class="FontTitulo">La consulta se conecta en línea al Servicio Web del MININTER, disponible en la plataforma de Interoperabilidad del Estado.</label>
        </div> 
